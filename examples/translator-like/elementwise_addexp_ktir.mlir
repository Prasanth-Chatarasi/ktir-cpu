module {
  func.func @addexp_kernel(
    ...
    %init_sum = tensor.empty() : tensor<128xf16>
    %sum = linalg.add
              ins(%x, %y : tensor<128xf16>, tensor<128xf16>)
              outs(%init_sum : tensor<128xf16>) -> tensor<128xf16>

    %init_exp = tensor.empty() : tensor<128xf16>
    %output = linalg.exp
                ins(%sum : tensor<128xf16>)
                outs(%init_exp : tensor<128xf16>) -> tensor<128xf16>
